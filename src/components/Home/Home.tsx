                    ...
                    <div className={styles.Technologies}>
                        <div className={styles.TechnologiesSection}>
                            ...
                            <div className={styles.TechIcons}>
                                <img className={styles.TechImage} alt='Android Studio'
                                     src={'images/icons/technologies/Android_Studio_Icon.png'}/>
                                <img className={styles.TechImage} alt='Unity'
                                     src={'images/icons/technologies/Unity_Icon.png'}/>
                                <img className={styles.TechImage} alt='Phaser'
                                     src={'images/icons/technologies/Phaser_Icon.png'}/>
                                <img className={styles.TechImage} alt='Game Maker Studio'
                                     src={'images/icons/technologies/Phaser_Icon.png'}/>
                            </div>
                        </div>
                        <div className={styles.TechnologiesSection}>
                            ...
                            <div className={styles.TechIcons}>
                                <img className={styles.TechImage} alt='C#'
                                     src={'images/icons/technologies/CSharp_Icon.png'}/>
                                <img className={styles.TechImage} alt='Kotlin'
                                     src={'images/icons/technologies/Kotlin_Icon.png'}/>
                                <img className={styles.TechImage} alt='JavaScript'
                                     src={'images/icons/technologies/Javascript_Icon.png'}/>
                                <img className={styles.TechImage} alt='Java'
                                     src={'images/icons/technologies/Javascript_Icon.png'}/>
                            </div>
                        </div>
                    </div>
